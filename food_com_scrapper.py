...
#
'''
This will download the recipe(s) from the url provided from food.com.
The output will be written to the current directory.
'''
import argparse
import ast
import os
# used for debug purposes... comment out for production
#import sys
...
PROG_DESC = '''
This will download the recipe from the url provided from food.com.
The output will be written to the current directory.
The output filename is reqired to be entered on the command line.
'''
...
def save_input_recipes(infile):
    ''' This will read the file entered and save the list of urls from
    food.com'''
